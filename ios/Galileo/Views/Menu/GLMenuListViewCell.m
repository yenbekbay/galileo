...
static CGSize const kMenuViewCellIconSize = {40, 40};
static CGFloat const kMenuViewCellIconSpacing = 10;

@implementation GLMenuListViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    self.titleLabel.font = [UIFont fontWithName:@"Roboto-Regular" size:[UIFont menuItemTitleFontSize]];
