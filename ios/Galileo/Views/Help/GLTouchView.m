...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    self.innerCircle.layer.cornerRadius = self.innerCircle.height / 2;
    ...
    for (UIView *outerCircle in @[self.firstOuterCircle, self.secondOuterCircle]) {
        outerCircle.layer.cornerRadius = outerCircle.height / 2;
